...
# Ruta del archivo Excel (cambiar <user> por el usuario de la maquina o cambiar la ruta por la ruta de ubicacion)
excel_file = 'C:/Users/user/Desktop/Horarios.xlsx'
...
conn = pyodbc.connect(
   ...
   'SERVER=DESKTOP-4IS01D1\\SQLEXPRESS;' #cambiar la version de express
